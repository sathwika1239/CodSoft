...
def toggle_task():
    try:
        ...
        messagebox.showwarning("Warning", "Please select a task you've done.")
...
# a "Done Task" button
toggle_button = tk.Button(button_frame, text="Task Done", command=toggle_task, font=button_font)
